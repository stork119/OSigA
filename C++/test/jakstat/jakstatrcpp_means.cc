...
Ith(ydot, 1) =  (p[4]*p[12]*y[13]*2.0)/p[11]-((p[11]*y[17]+p[13]*y[16])*p[1]*y[1])/((p[6]+y[1])*p[11]);
Ith(ydot, 2) =  p[2]*(y[2]*y[2])*-2.0+((p[11]*y[17]+p[13]*y[16])*p[1]*y[1])/((p[6]+y[1])*p[11]);
...
IJth(J, 1, 1) =  -((p[11]*y[17]+p[13]*y[16])*p[1])/((p[6]+y[1])*p[11])+(1.0/pow(p[6]+y[1],2.0)*(p[11]*y[17]+p[13]*y[16])*p[1]*y[1])/p[11];
IJth(J, 1, 13) =  (p[4]*p[12]*2.0)/p[11];
IJth(J, 1, 16) =  -(p[1]*p[13]*y[1])/((p[6]+y[1])*p[11]);
IJth(J, 1, 17) =  -(p[1]*y[1])/(p[6]+y[1]);
IJth(J, 2, 1) =  ((p[11]*y[17]+p[13]*y[16])*p[1])/((p[6]+y[1])*p[11])-(1.0/pow(p[6]+y[1],2.0)*(p[11]*y[17]+p[13]*y[16])*p[1]*y[1])/p[11];
IJth(J, 2, 2) =  p[2]*y[2]*-4.0;
IJth(J, 2, 16) =  (p[1]*p[13]*y[1])/((p[6]+y[1])*p[11]);
